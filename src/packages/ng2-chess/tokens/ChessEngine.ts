...
import { Block, Piece, PieceColor, PieceType, GAME_STATE, ChessMove, AIQuery } from '../index';
...
export abstract class ChessEngine {
   ...
   */
  public stateChanged: EventEmitter<GAME_STATE> = new EventEmitter<GAME_STATE>();
   ...
   * @type {EventEmitter}
   */
  public boardSynced: EventEmitter<void> = new EventEmitter<void>();
