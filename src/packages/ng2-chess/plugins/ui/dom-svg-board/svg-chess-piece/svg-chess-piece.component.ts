...
import { Piece, ChessEngine } from '../../../../../ng2-chess';
import { PieceDragEvent, SVGChessBlock } from '../index';
...
@Component({
  ...
  template: require('./svg-chess-piece.template.html'),
  styles: [ require('./svg-chess-piece.styles.css') ],
